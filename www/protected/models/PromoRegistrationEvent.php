 ...
 */
class PromoRegistrationEvent extends CActiveRecord
{
	/**
	...
	{
		return 'promo_registration_events';
	}
	...
	public function rules()
	{
		...
		return array(
			array('dt_registered, soas_id, promo_ident', 'required'),
			array('soas_id, promo_ident', 'numerical', 'integerOnly'=>true),
